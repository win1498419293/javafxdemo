...
//        return this;
         ...
         */
        public Payload selectModelAndVul(String vulntype, String vulNum) {
        ...
        public Payload selectExec(String command, String... os) {
         ...
         * @param encode      执行的编码
         */
        public Payload selectUpload(String filename, String filecontent, String encode) {
